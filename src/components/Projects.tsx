    ...
    <>
      <div className="flex flex-col gap-2">
        <span className="text-gray-300">
          You can find a few projects separated by categories here. If you want
          to know more, click the title of the project.
        </span>
        ...
        <div>
          ...
          <div className="flex gap-8">
            <Link to="?category=fullstack">
              <span className="cursor-pointer underline text-gray-300">
                Fullstack
              </span>
            </Link>

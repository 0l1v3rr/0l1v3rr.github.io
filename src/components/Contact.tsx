  ...
  return (
    <div className="flex flex-col">
      ...
      <span className="text-gray-300">
        Here are my socials:{" "}
        <span className="text-gray-400">(Click the icons)</span>
      </span>
      ...
      <div className="flex gap-3 text-lg mt-2 items-center bg-white/[0.07] px-3 py-1 w-fit rounded-lg">
        ...
        <a
          className="text-blue-700 bg-white rounded-lg transition-all duration-300 
                    hover:text-blue-600"
          target="_blank"
          href="https://www.linkedin.com/in/0l1v3rr/"
        >
          <SiLinkedin />
        </a>
      </div>
      ...
      <div className="flex gap-3 text-lg mt-2 items-center bg-white/[0.07] px-3 py-1 w-fit rounded-lg">
        ...
        <a
          className="text-red-500 transition-all duration-300 hover:text-red-400"
          target="_blank"
          href="mailto:oliver.mrakovics@gmail.com"
        >
          <SiGmail />
        </a>
      </div>
      ...
      <div className="flex gap-3 text-lg mt-2 items-center bg-white/[0.07] px-3 py-1 w-fit rounded-lg">
        ...
        <a
          ...
          target="_blank"
          href="https://profile.codersrank.io/user/0l1v3rr/"
        >
          <SiCodersrank />
        </a>
      </div>

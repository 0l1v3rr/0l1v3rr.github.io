    ...
    <>
      ...
      <Project
        project={{
          ...
          description:
            "🖨️ A simple command-line tool to calculate IPv4 subnets.",
          category: "cli-app",
          techStack: ["Go"],
        }}
      />
      ...
      <Project
        project={{
          ...
          title: "Port Scanner",
          description:
            "🛡️ This is a terminal application that allows you to find opened ports on a network.",
          category: "cli-app",
          techStack: ["Go"],
        }}
      />
      ...
      <Project
        project={{
          ...
          title: "JFMT",
          description:
            "🔬 An easy-to-use Java library to format strings and write colored outputs more easily.",
          category: "library",
          techStack: ["Java"],
        }}
      />

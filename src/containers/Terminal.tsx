...
const Terminal = () => {
  ...
  useEffect(() => {
    container!.current!.onfullscreenchange = (e) =>
  ...
  return (
    <div
      ref={container}
      className="w-full h-full sm:rounded-lg bg-black/[.8] shadow-md
            shadow-black backdrop-blur-lg border border-solid border-gray-800 overflow-auto
            transition-all duration-300"
    >
      <div
        className="flex items-center justify-center sm:justify-start border-solid 
                border-gray-900 w-full"
      >
        <div
          className="hidden sm:flex gap-2 items-center justify-center px-4 py-[15.5px] pr-10 
                    bg-white/[0.02] border-b border-solid border-gray-800"
        >
          <div
            className="block w-3 h-3 bg-red-500 transition-all hover:bg-red-400 
                        cursor-pointer duration-300 rounded-full border border-solid border-red-800"
            onClick={closeWindow}
          />
          <div
            className="block w-3 h-3 bg-gray-600 transition-all
                        duration-300 rounded-full border border-solid border-gray-800"
          />
          {!isFullScreen && (
            <div
              className="block w-3 h-3 bg-green-500 transition-all 
        ...
        <div className="flex items-center justify-center w-full">
          ...
          <div
            className="text-gray-600 w-100 text-sm pt-8 pb-[11px]

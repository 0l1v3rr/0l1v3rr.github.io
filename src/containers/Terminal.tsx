const Terminal = () => {
    ...
    return (
        <div className="w-full h-full rounded-lg bg-black/[.8] shadow-md
            shadow-black backdrop-blur-lg border border-solid border-gray-800">
            <div className="flex items-center border-b border-solid border-gray-900 bg-white/[0.02]">
                <div className="flex gap-2 items-center p-4 pr-10">
                ...
                <div className="flex items-center justify-center">
                    <div className="text-gray-200 text-sm mx-10 py-3 cursor-pointer">
                        ../Home (-zsh)
                    </div>

                    <div className="text-gray-400 text-sm mx-10 py-3 cursor-pointer 
